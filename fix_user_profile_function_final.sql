-- Fix the create_user_profile_safe function to resolve ambiguous column references
...
BEGIN
    ...
    -- Insert user points with explicit column reference
    ...
    ON CONFLICT (user_points.user_id) DO UPDATE SET
        updated_at = NOW();
...
-- Test the function
SELECT 'Function create_user_profile_safe fixed successfully' as status; 