...
-- This will completely remove the problematic trigger and fix signup permanently

SELECT '=== DEFINITIVE SIGNUP FIX ===' as section;
...
-- 8. Create a simple points function
SELECT '=== STEP 8: CREATING SIMPLE POINTS FUNCTION ===' as section;
...
BEGIN
  ...
  BEGIN
    ...
    VALUES (
      test_user_id, 
      'test-definitive@example.com', 
      'Test Definitive User', 
      'player', 
      NULL,
