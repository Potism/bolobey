-- Fix Notifications and Points Display Issues
-- This script fixes both notification messages and ensures proper point tracking

-- 1. First, let's check if the user_notifications table exists, if not create it
...
-- 2. Fix the notification function to show correct amounts
...
-- 3. Update the trigger to pass correct data
...
-- 5. Ensure the get_user_points_balance function returns correct data
...
-- 6. Create a function to manually process existing bets and create notifications
