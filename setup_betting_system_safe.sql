-- Complete Betting System Setup - SAFE VERSION
...
-- 7. Create functions for common operations (safe version)
...
-- Drop existing place_bet function if it exists, then recreate
...
-- 10. Create function to give new users 50 points (safe version)
...
-- 11. Create trigger to automatically give points to new users (safe version)
